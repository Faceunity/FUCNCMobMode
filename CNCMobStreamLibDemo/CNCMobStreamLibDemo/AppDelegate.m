...
//    [self umengTrack];
    ...
    [[NSUserDefaults standardUserDefaults] setObject:@"CNCMobSteamSDK_App_ID" forKey:@"CNCMobSteamSDK_App_ID"];
    [[NSUserDefaults standardUserDefaults] setObject:@"CNCMobSteamSDK_Auth_Key" forKey:@"CNCMobSteamSDK_Auth_Key"];
