...
- (void)setupViews {
    ...
    STButton *backBtn = [[STButton alloc] initWithFrame:CGRectMake(12, 50, 7, 11)];
    ...
    STFilterCollectionView *filterCollectionView = [[STFilterCollectionView alloc] initWithFrame:CGRectMake(CGRectGetMaxX(leftView.frame) + 20, 0, self.frame.size.width - 77, 140) withModels:nil andDelegateBlock:nil];
